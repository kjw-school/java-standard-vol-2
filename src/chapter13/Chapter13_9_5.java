 ...
 * <code><br>
 *     public abstract class RecursiveAction extends ForkJoinTask<Void> {<br>
 *      	...<br>
 *      	protected abstract void compute(); // 상속을 통해 이 메서드를 구현해야 한다.<br>
 *      	...	<br>
 *     }<br>
 *     <br>
 *     public abstract class RecursiveTask<V> extends ForkJoinTask<V> {<br>
 *         ...<br>
 *         V result;<br>
 *         protected abstract void compute(); // 상속을 통해 이 메서드를 구현해야 한다.<br>
 *     }<br>
...
public class Chapter13_9_5 {
	 ...
	 *
	 * 		return rightSum.compute() + leftSum.join();<br>
	 *
	 *        }
	 * </code><br>
	 ...
	 * fork()는 작업을 쓰레드의 작업 큐에 넣는 것이고, 작업 큐에 들어간 작업은 더 이상 나눌수 없을 때가지 나뉜다.<br>
